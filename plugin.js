(function() {
  ...
  function startPlugin() {
    ...
    var manifst = {
      ...
      version: '1.4.9',
      name: 'test ed',
      description: 'Плагин для просмотра онлайн сериалов и фильмов с 4K контентом',
      component: 'bwarch',
